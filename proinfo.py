...
"""
    ProInfo - All in one Information gathering tool.
    This file is part of ProInfo Project

    Written by: @muneebwanee
    Website: https://muneb.rf.gd/
    GIT: https://github.com/muneebwanee/proinfo
...
__credits__ = ["muneebwanee", "thedeepnet"]
__license__ = "GPLv3"
__version__ = "1.0"
...
ProInfo v. {} - All in one Information gathering tool.
ProInfo is an open source tool licensed under GPLv3.
Written by: @muneebwanee, thedeepnet
https://muneeb.rf.gd/
